...
<div class="payment">
  ...
  <div class="payment-list">
    ...
    <a href="https://shoperkart-rel.herokuapp.com/payments/mycredential?userId={{auth()->user()->id}}" role="button" class="btn btn-warning"><i class="fa fa-credit-card-alt" aria-hidden="true"></i> Buy Subscription </a>
...
<div class="sidenav">
  ...
  <a href="/payments-history"><i class="fa fa-credit-card" aria-hidden="true"></i>Payments history</a>
